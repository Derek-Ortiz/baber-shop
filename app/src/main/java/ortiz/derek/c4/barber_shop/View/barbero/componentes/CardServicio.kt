...
fun CardServicio(
    ...
    val animatedCardColor by animateColorAsState(targetValue = if (isPressed) PrimaryBlue else White, label = "")
    val animatedTextColor by animateColorAsState(targetValue = if (isPressed) Color.White else Color.Black, label = "")
    val animatedPriceColor by animateColorAsState(targetValue = if (isPressed) Color.Yellow else PrimaryBlue, label = "")
